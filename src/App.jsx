...
const Widget = ({ title, icon: Icon, children, className = '', delay = 0 }) => (
    ...
    <div className="app-container">
      ...
      <header className="app-header">
        <div className="header-brand">
          ...
          <h1 className="brand-title">Dollar Tree Enterprise KTLO</h1>
        </div>
      ...
      <main className="dashboard-content">
        ...
        {/* Row 1: E-Commerce & Store Systems */}
        <Widget title="E-Commerce & Digital" icon={Icons.Cart} className="widget-half" delay={0.1}>
        ...
        <Widget title="Store Applications (POS)" icon={Icons.Store} className="widget-half" delay={0.2}>
          <div className="table-container">
            <table className="data-table">
              <thead>
                <tr>
        ...
        {/* Row 2: Logistics and Payments */}
        <Widget title="Distribution Centers (DCs)" icon={Icons.Truck} className="widget-third" delay={0.3}>
          <div className="table-container">
            <table className="data-table">
              <thead>
                <tr>
        ...
        <Widget title="Payment Gateways" icon={Icons.Card} className="widget-third" delay={0.4}>
          <div className="table-container">
            <table className="data-table">
              <thead>
                <tr>
        ...
        <Widget title="System Health" icon={Icons.Activity} className="widget-third" delay={0.5}>
        ...
        <Widget title="Core Infrastructure" icon={Icons.Server} className="widget-half" delay={0.6}>
          <div className="table-container">
            <table className="data-table">
              <thead>
                <tr>
        ...
        <Widget title="Databases" icon={Icons.Database} className="widget-half" delay={0.7}>
          <div className="table-container">
            <table className="data-table">
              <thead>
                <tr>
